...
sales <- sales %>% 
  select(cat_no, lot_no, auction_house, date, transaction_type, type_is_uncertain, amt_is_uncertain, has_double_price, transaction_amt, year, month, week, yday, mday, wday)
```
